...
<qgis version="3.34.0" styleCategories="AllStyleCategories">
  <renderer-v2 type="categorizedSymbol" attr="restriction" symbollevels="0" forceraster="0" enableorderby="0">
    <categories>
      ...
      <category symbol="3" value="no_straight_on" label="No Straight On" render="true"/>
      <category symbol="4" value="only_straight_on" label="Only Straight On" render="true"/>
      <category symbol="5" value="only_left_turn" label="Only Left Turn" render="true"/>
      <category symbol="6" value="only_right_turn" label="Only Right Turn" render="true"/>
    </categories>
    <symbols>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map"><Option type="QString" name="No Left Turn" value="no_left_turn"/></Option>
              <Option type="Map"><Option type="QString" name="No Right Turn" value="no_right_turn"/></Option>
              <Option type="Map"><Option type="QString" name="No U-Turn" value="no_u_turn"/></Option>
              <Option type="Map"><Option type="QString" name="No Straight On" value="no_straight_on"/></Option>
              <Option type="Map"><Option type="QString" name="Only Straight On" value="only_straight_on"/></Option>
              <Option type="Map"><Option type="QString" name="Only Left Turn" value="only_left_turn"/></Option>
              <Option type="Map"><Option type="QString" name="Only Right Turn" value="only_right_turn"/></Option>
            </Option>
          </Option>
        </config>
      </editWidget>
  ...
  <aliases>
    ...
    <alias field="type" index="1" name="Type"/>
    <alias field="restriction" index="2" name="Restriction"/>
    <alias field="from_way" index="3" name="From Way"/>
    <alias field="to_way" index="4" name="To Way"/>
    <alias field="except" index="5" name="Exceptions"/>
  </aliases>
  <defaults>
